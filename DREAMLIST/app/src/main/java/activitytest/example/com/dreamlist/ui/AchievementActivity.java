...
public class AchievementActivity extends BaseActivity  implements AbsListView.OnScrollListener,
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        addNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, AchievementEdit.class);
    ...
    private List<Map<String, Object>> getData() {
        ...
        Cursor cursor = dbread.query("notea", null, "content!=\"\"", null, null,
                null, null);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        Cursor c = dbread.query("notea", null,
        ...
        while (c.moveToNext()) {
            ...
            myIntent.setClass(AchievementActivity.this, DreamListEdit.class);
    ...
    public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2,
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String content1 = content.substring(content.indexOf("=") + 1,
                        content.indexOf(","));
                Cursor c = dbread.query("notea", null, "content=" + "'"
                        + content1 + "'", null, null, null, null);
                while (c.moveToNext()) {
                    String id = c.getString(c.getColumnIndex("_id"));
                    String sql_del = "update notea set content='' where _id="
                            + id;
